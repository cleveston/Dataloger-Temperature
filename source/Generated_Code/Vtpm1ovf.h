...
**         Handle name                 : timer1
**         Interrupt request reg.      : TPM1SC    [$0040]
**         Interrupt enable reg.       : TPM1SC    [$0040]
**     Contents    :
**         No public methods
**
...
*/         
/*!
**  @addtogroup Vtpm1ovf_module Vtpm1ovf module documentation
**  @{
*/         
...
** of the user modules (see Vtpm1ovf.c file for more information).
** ===================================================================
*/
